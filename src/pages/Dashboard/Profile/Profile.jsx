...
import { FaUser, FaEnvelope, FaIdCard, FaMotorcycle, FaPhone, FaMapMarkerAlt, FaShieldAlt } from 'react-icons/fa';
  ...
  return (
    <div className="flex justify-center bg-[#F5F5F5] px-4 py-10 w-full min-h-screen">
      <div className="space-y-6 w-full max-w-4xl">
        ...
        {/* Main Profile Card */}
        <div className="bg-white shadow-md p-6 md:p-8 rounded-2xl">
          <div className="flex sm:flex-row flex-col items-center sm:items-start gap-6">
            <img
              src={user?.photoURL || 'https://i.ibb.co/mR4qB2v/user-placeholder.png'}
              alt="Profile"
              className="border-[#C6F16A] border-4 rounded-full w-28 h-28 object-cover"
            />
            <div className="space-y-2 sm:text-left text-center">
              <div className="flex flex-wrap justify-center sm:justify-start items-center gap-3">
                ...
                <span className="bg-[#C6F16A] px-3 py-1 rounded-full font-bold text-black text-xs uppercase">
                  {dbUser?.role || 'User'}
                </span>
              </div>
            ...
            <div className="gap-6 grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="flex items-center gap-4 bg-gray-50 p-4 border border-gray-100 rounded-xl">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">
                    {dbUser?.district ? `${dbUser?.district}, ${dbUser?.region}` : 'N/A'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-gray-50 p-4 border border-gray-100 rounded-xl">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">
                    {dbUser?.bikeModel ? `${dbUser?.bikeModel} (${dbUser?.bikeRegNo})` : 'N/A'}
                  </p>
                </div>
              </div>
            </div>
