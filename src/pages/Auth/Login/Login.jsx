  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
        ...
        {/* Email Field */}
        <div>
          <label className="block mb-1.5 font-bold text-[#03373D] text-xs">
            Email Address
          </label>
          <div className="relative">
            ...
            <input
              ...
              className="bg-gray-50/60 focus:bg-white py-3 pr-4 pl-10 border border-gray-200 focus:border-[#03373D] rounded-xl focus:outline-none w-full text-[#03373D] text-sm transition-all"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-gray-50/60 focus:bg-white py-3 pr-10 pl-10 border border-gray-200 focus:border-[#03373D] rounded-xl focus:outline-none w-full text-[#03373D] text-sm transition-all"
              placeholder="••••••••"
            />
            <button
              type="button"
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex justify-center items-center bg-[#C7EA52] hover:bg-[#b8dd42] disabled:opacity-50 shadow-sm hover:shadow-md py-3 rounded-xl w-full font-bold text-[#03373D] text-sm active:scale-[0.99] transition-all cursor-pointer"
        >
          {loading ? (
